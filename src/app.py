...
def naive_chroma_search_good(query:str, limit:int=5, cycles=300):
    return _naive_search(store_chroma_good, query, limit, cycles)

def naive_chroma_search_bad(query:str, limit:int=5, cycles=300):
    return _naive_search(store_chroma_bad, query, limit, cycles)

def naive_qdrant_search_good(query:str, limit:int=5, cycles=300):
    return _naive_search(store_qdrant_good, query, limit, cycles)

def naive_qdrant_search_bad(query:str, limit:int=5, cycles=300):
